# El plugin fue modificado para un proyecto personal, no somos dueños del proyecto, dejamos el link del proyecto original https://pub.dev/packages/flutter_inappwebview
